#include "projet.h"
#include <sys/time.h>
/* 2017-05-06 : version 1.0 améliorée MPI pur */
#include <mpi.h>
...
{ 
	...
	if(my_rank==0){
		...
		/*À la première profondeur, on n'est pas obligés d'envoyer un arbre entier, mais juste la profondeur et le coup à jouer*/
		if(T->height==0){
